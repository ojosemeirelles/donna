...
Keep `~/.donna/workspace` as canonical human-readable memory.
...
Recommendation: **deep integration in Donna**, but keep a separable core library.

### Why integrate into Donna?
...
Pragmatic take for `~/.donna/workspace`:
