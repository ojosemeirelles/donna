...
本指南总结了在 Donna 中开发 Pi 集成的合理工作流程。
...
状态存储在 Donna 状态目录下。默认为 `~/.donna`。如果设置了 `DONNA_STATE_DIR`，则使用该目录。
...
- https://docs.donna.ai/testing
- https://docs.donna.ai/start/getting-started
