...
- `donna-canvas://main/` → `<canvasRoot>/main/index.html`
- `donna-canvas://main/assets/app.css` → `<canvasRoot>/main/assets/app.css`
- `donna-canvas://main/widgets/todo/` → `<canvasRoot>/main/widgets/todo/index.html`
...
```
http://<gateway-host>:18793/__donna__/a2ui/
```
