...
Donna ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Donna also aligns
the install method:
...
When you switch channels with `donna update`, Donna also syncs plugin sources:
