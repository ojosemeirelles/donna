...
read_when:
  ...
  - Reviewing Donna security posture
title: "Pairing"
---

# Pairing

“Pairing” is Donna’s explicit **owner approval** step.
...
Stored under `~/.donna/credentials/`:
...
3. On your phone, open the Donna iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `donna nodes pending/approve`) is a
