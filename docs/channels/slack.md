...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Donna HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `donna pairing approve slack <code>`.
...
Donna supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Donna falls back to normal delivery for remaining payloads.
