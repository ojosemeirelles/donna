---
summary: "Synology Chat webhook setup and Donna config"
read_when:
  - Setting up Synology Chat with Donna
...
```bash
donna plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your Donna gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in Donna.
...
- Pairing approvals work with:
  - `donna pairing list synology-chat`
  - `donna pairing approve synology-chat <CODE>`
...
```bash
donna message send --channel synology-chat --target 123456 --text "Hello from Donna"
donna message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
