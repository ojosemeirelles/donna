...
- Install via CLI: `donna plugins install @donna/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `donna plugins install ./extensions/zalo`
   - From npm (if published): `donna plugins install @donna/zalo`
...
- Approve via:
  - `donna pairing list zalo`
  - `donna pairing approve zalo <CODE>`
...
- Example: `donna message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `donna channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `donna logs --follow`
