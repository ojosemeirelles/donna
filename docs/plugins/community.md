...
read_when:
  - You want to publish a third-party Donna plugin
...
This page tracks high-quality **community-maintained plugins** for Donna.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `donna plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `donna plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect Donna to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/donna-wechat`
  repo: `https://github.com/icesword0760/donna-wechat`
  install: `donna plugins install @icesword760/donna-wechat`
