...
read_when:
  - You want Zalo Personal (unofficial) support in Donna
...
Zalo Personal support for Donna via a plugin, using native `zca-js` to automate a normal Zalo user account.
