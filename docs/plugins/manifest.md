...
read_when:
  - You are building a Donna plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (donna.plugin.json)

Every plugin **must** ship a `donna.plugin.json` file in the **plugin root**.
Donna uses this manifest to validate configuration **without executing plugin
