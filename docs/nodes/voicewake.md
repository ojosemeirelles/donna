...
Donna treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.donna/settings/voicewake.json`

Shape:

```json
{ "triggers": ["donna", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
