---
summary: "First-run onboarding flow for Donna (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Donna">
...
<Step title="CLI">
  ...
  The app can install the global `donna` CLI via npm/pnpm so terminal
