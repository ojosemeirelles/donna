---
summary: "Overview of Donna onboarding options and flows"
read_when:
...
Donna supports multiple onboarding paths depending on where the Gateway runs
...
- [`donna onboard` command](/cli/onboard)

## macOS app onboarding

Use the Donna app when you want a fully guided setup on macOS. Docs:
