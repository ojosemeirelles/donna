---
summary: "VPS hosting hub for Donna (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `DONNA_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `DONNA_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/donna-compile-cache`
