...
You can point Donna at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Donna
...
- [Anthropic provider](/providers/anthropic) - Native Donna integration with Claude setup-token or API keys
