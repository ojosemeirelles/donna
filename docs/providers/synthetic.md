---
summary: "Use Synthetic's Anthropic-compatible API in Donna"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Donna registers it as the
...
Note: Donna's Anthropic client appends `/v1` to the base URL, so use
