---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Donna"
read_when:
  - You want Xiaomi MiMo models in Donna
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Donna uses
