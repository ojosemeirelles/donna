---
summary: "Use NVIDIA's OpenAI-compatible API in Donna"
read_when:
  - You want to use NVIDIA models in Donna
...
donna onboard --auth-choice skip
donna models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
