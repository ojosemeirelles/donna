---
summary: "Use Qianfan's unified API to access many models in Donna"
read_when:
...
3. Donna installed on your system
...
4. Copy the API key for use with Donna

## CLI setup

```bash
donna onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Donna Configuration](/gateway/configuration)
