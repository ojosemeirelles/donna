/**
 * Twitch channel plugin for Donna.
 *
 * Main plugin export combining all adapters (outbound, actions, status, gateway).
 * This is the primary entry point for the Twitch channel integration.
 */

import type { DonnaConfig } from "donna/plugin-sdk/twitch";
import { buildChannelConfigSchema } from "donna/plugin-sdk/twitch";
 ...
 * for Donna. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<TwitchAccountConfig> = {
  ...
  config: {
    ...
    listAccountIds: (cfg: DonnaConfig): string[] => listAccountIds(cfg),

    /** Resolve an account config by ID */
    resolveAccount: (cfg: DonnaConfig, accountId?: string | null): TwitchAccountConfig => {
    ...
    isConfigured: (_account: unknown, cfg: DonnaConfig): boolean => {
