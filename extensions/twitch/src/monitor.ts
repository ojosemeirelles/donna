...
import type { ReplyPayload, DonnaConfig } from "donna/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "donna/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as DonnaConfig;
