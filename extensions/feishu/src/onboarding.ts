...
function setFeishuDmPolicy(cfg: DonnaConfig, dmPolicy: DmPolicy): DonnaConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: DonnaConfig, allowFrom: string[]): DonnaConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: DonnaConfig, groupAllowFrom: string[]): DonnaConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
