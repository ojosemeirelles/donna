...
import { fetchWithSsrFGuard } from "donna/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Donna workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".donna", "workspace", "media", "inbound");
 ...
 * Format matches Donna's expected attachment structure.
 */
