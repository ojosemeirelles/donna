import type { LineChannelData, DonnaPluginApi, ReplyPayload } from "donna/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: DonnaPluginApi): void {
  api.registerCommand({
    name: "card",
