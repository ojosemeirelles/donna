import type { DonnaConfig, PluginRuntime, ResolvedLineAccount } from "donna/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: DonnaConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: DonnaConfig; accountId: string }): Promise<{
