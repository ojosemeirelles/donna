...
export function listMattermostAccountIds(cfg: DonnaConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: DonnaConfig): string {
...
export function listEnabledMattermostAccounts(cfg: DonnaConfig): ResolvedMattermostAccount[] {
