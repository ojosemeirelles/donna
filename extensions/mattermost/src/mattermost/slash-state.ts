...
import type { DonnaPluginApi } from "donna/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("donna/plugin-sdk/mattermost").DonnaConfig;
    runtime: import("donna/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: DonnaPluginApi) {
