import type {
  ...
  PluginLogger,
} from "donna/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "donna/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: DonnaPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: DonnaPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
