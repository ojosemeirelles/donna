...
Nostr DM channel plugin for Donna using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Donna. It enables your bot to:
...
# Configure donna to use local relay
