...
import { resolveChannelMediaMaxBytes, type DonnaConfig } from "donna/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: DonnaConfig; accountId?: string }): string[] {
