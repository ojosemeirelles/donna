...
import type { DonnaConfig } from "donna/plugin-sdk/bluebubbles";
...
export function listBlueBubblesAccountIds(cfg: DonnaConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: DonnaConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: DonnaConfig): ResolvedBlueBubblesAccount[] {
