...
This directory contains the **BlueBubbles external channel plugin** for Donna.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `donna/plugin-sdk` helpers.
