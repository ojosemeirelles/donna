...
import { isSecretRef } from "donna/plugin-sdk/googlechat";
...
export function listGoogleChatAccountIds(cfg: DonnaConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: DonnaConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: DonnaConfig): ResolvedGoogleChatAccount[] {
