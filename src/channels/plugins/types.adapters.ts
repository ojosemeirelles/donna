...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: DonnaConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: DonnaConfig) => string;
  setAccountEnabled?: (params: {
    cfg: DonnaConfig;
    accountId: string;
    enabled: boolean;
  }) => DonnaConfig;
  deleteAccount?: (params: { cfg: DonnaConfig; accountId: string }) => DonnaConfig;
  isEnabled?: (account: ResolvedAccount, cfg: DonnaConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: DonnaConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: DonnaConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: DonnaConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: DonnaConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.donna.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: DonnaConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
