...
export function listChannelMessageActions(cfg: DonnaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: DonnaConfig): boolean {
...
export function supportsChannelMessageCards(cfg: DonnaConfig): boolean {
