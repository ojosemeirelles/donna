...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: DonnaConfig): string | undefined {
  ...
  function listAccountIds(cfg: DonnaConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: DonnaConfig): string {
