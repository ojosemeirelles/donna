...
import { discoverDonnaPlugins } from "../../plugins/discovery.js";
import type { DonnaPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, DonnaPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["DONNA_PLUGIN_CATALOG_PATHS", "DONNA_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<DonnaPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: DonnaPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverDonnaPlugins({ workspaceDir: options.workspaceDir });
