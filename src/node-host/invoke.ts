...
const execHostEnforced = process.env.DONNA_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.DONNA_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
