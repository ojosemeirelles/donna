...
function mergeDiscordAccountConfig(cfg: DonnaConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: DonnaConfig): ResolvedDiscordAccount[] {
