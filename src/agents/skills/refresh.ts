...
function resolveWatchPaths(workspaceDir: string, config?: DonnaConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: DonnaConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: DonnaConfig }) {
