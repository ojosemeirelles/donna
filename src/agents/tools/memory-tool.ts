...
function resolveMemoryToolContext(options: { config?: DonnaConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: DonnaConfig): MemoryCitationsMode {
