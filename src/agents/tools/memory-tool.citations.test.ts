...
function asDonnaConfig(config: Partial<DonnaConfig>): DonnaConfig {
  return config as DonnaConfig;
}

function createToolConfig() {
  return asDonnaConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: DonnaConfig = createToolConfig()) {
