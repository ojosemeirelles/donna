...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): DonnaConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: DonnaConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: DonnaConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
