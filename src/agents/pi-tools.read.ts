...
function resolveAdaptiveReadMaxBytes(options?: DonnaReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createDonnaReadTool(base, {
...
export function createDonnaReadTool(
  base: AnyAgentTool,
  options?: DonnaReadToolOptions,
): AnyAgentTool {
