...
function resolveAvatarSource(cfg: DonnaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DonnaConfig, agentId: string): AgentAvatarResolution {
