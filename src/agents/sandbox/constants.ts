...
export const DEFAULT_SANDBOX_IMAGE = "donna-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "donna-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "donna-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "donna-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "donna-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "donna-sandbox-browser";
