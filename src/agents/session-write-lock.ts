...
const CLEANUP_STATE_KEY = Symbol.for("donna.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("donna.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("donna.sessionWriteLockWatchdogState");
