...
type AgentEntry = NonNullable<NonNullable<DonnaConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: DonnaConfig): AgentEntry[] {
...
export function listAgentIds(cfg: DonnaConfig): string[] {
...
export function resolveDefaultAgentId(cfg: DonnaConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: DonnaConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentSkillsFilter(cfg: DonnaConfig, agentId: string): string[] | undefined {
...
export function resolveAgentModelPrimary(cfg: DonnaConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: DonnaConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: DonnaConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
