import type { DonnaConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: DonnaConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: DonnaConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[donna]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: DonnaConfig, channel: string): Record<string, unknown> | undefined {
