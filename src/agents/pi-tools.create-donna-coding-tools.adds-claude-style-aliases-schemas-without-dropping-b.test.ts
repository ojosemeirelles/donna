...
const defaultTools = createDonnaCodingTools({ senderIsOwner: true });
...
describe("createDonnaCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: DonnaConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createDonnaCodingTools({
    ...
    const anthropicTools = createDonnaCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: DonnaConfig = {
      tools: {
        exec: {
    ...
    const allowed = createDonnaCodingTools({
    ...
    const denied = createDonnaCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createDonnaCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
