...
function buildCoreToolGroupMap() {
  ...
  const donnaTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInDonnaGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:donna": donnaTools,
