...
function resolveDefaultAccountId(cfg: DonnaConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: DonnaConfig): boolean {
...
export function summarizeBindings(cfg: DonnaConfig, bindings: AgentBinding[]): string[] {
