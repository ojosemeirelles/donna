...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.donna.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("donna hooks list")}`,
      `  ${formatCliCommand("donna hooks enable <name>")}`,
      `  ${formatCliCommand("donna hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
