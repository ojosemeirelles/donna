...
export function isAcpEnabledByPolicy(cfg: DonnaConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: DonnaConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: DonnaConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: DonnaConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: DonnaConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: DonnaConfig, agentId: string): boolean {
