...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: DonnaConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: DonnaConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: DonnaConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: DonnaConfig }): Promise<void> {
