...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof DonnaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: DonnaConfig; env: NodeJS.ProcessEnv }): {
  cfg: DonnaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
