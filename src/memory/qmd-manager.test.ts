...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: DonnaConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__donnaMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__donnaMcporterColdStartWarned;
  });
