...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: DonnaConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: DonnaConfig): Promise<MessageChannelId[]> {
