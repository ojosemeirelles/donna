...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/donna/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/donna/extensions",
        global: "/Users/x/.donna/extensions",
        workspace: "/Users/x/ws/.donna/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.donna/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/donna/extensions",
        global: "/Users/x/.donna/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.donna/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/donna/extensions",
        global: "/Users/x/.donna/extensions",
