 ...
 *
 * @see https://github.com/donna/donna/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an DonnaConfig.
 */
export function timestampOptsFromConfig(cfg: DonnaConfig): TimestampInjectionOptions {
  return {
