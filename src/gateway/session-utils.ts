...
import { type DonnaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: DonnaConfig): string[] {
...
export function listAgentsForGateway(cfg: DonnaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: DonnaConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: DonnaConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: DonnaConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: DonnaConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: DonnaConfig): GatewaySessionsDefaults {
