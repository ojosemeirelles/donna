...
export function listWhatsAppAuthDirs(cfg: DonnaConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: DonnaConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: DonnaConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: DonnaConfig): ResolvedWhatsAppAccount[] {
