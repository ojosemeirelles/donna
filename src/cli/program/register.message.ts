...
${formatHelpExamples([
  ['donna message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'donna message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'donna message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.donna.ai/cli/message")}`,
    )
    .action(() => {
