    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["donna channels list", "List configured channels and auth profiles."],
          ["donna channels status --probe", "Run channel status checks and probes."],
          [
            "donna channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["donna channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.donna.ai/cli/channels",
        )}\n`,
    );
