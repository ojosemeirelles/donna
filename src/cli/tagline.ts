const DEFAULT_TAGLINE = "All your chats, one Donna.";
...
const TAGLINES: string[] = [
  ...
  "Moon's up, commit in—let's ship something mildly responsible.",
  "I don't sleep, I just plan your next move.",
  "Shell yeah—I'm here to handle the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only AI in your contacts you actually want to hear from. 🌙",
  ...
  "Built by moonlight, for humans. Don't question the hierarchy.",
  ...
  "Half butler, half debugger, full moonlight.",
  ...
  "You had me at 'donna gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.DONNA_TAGLINE_INDEX;
