    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["donna directory self --channel slack", "Show the connected account identity."],
          [
            'donna directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["donna directory groups list --channel discord", "List available groups/channels."],
          [
            "donna directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.donna.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
