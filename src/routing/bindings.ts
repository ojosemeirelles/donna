...
export function listBindings(cfg: DonnaConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: DonnaConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: DonnaConfig) {
