...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.DONNA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: DonnaConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: DonnaConfig): string {
...
function mergeTelegramAccountConfig(cfg: DonnaConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
  ...
  // See: https://github.com/donna/donna/issues/30673
...
export function listEnabledTelegramAccounts(cfg: DonnaConfig): ResolvedTelegramAccount[] {
