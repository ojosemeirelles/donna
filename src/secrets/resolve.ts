...
function resolveResolutionLimits(config: DonnaConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: DonnaConfig): SecretProviderConfig {
