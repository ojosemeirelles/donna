...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.DONNA_TTS_PREFS;
      process.env.DONNA_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.DONNA_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: DonnaConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
