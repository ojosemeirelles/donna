...
export const A2UI_PATH = "/__donna__/a2ui";

export const CANVAS_HOST_PATH = "/__donna__/canvas";

export const CANVAS_WS_PATH = "/__donna__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.donnaCanvasA2UIAction.postMessage(...)
  // - Android: window.donnaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["donnaCanvasA2UIAction"];
  ...
  globalThis.Donna = globalThis.Donna ?? {};
  globalThis.Donna.postMessage = postToNode;
  globalThis.Donna.sendUserAction = sendUserAction;
  globalThis.donnaPostMessage = postToNode;
  globalThis.donnaSendUserAction = sendUserAction;
