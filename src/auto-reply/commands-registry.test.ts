...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@donna", { botUsername: "donna" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@donna args", {
        botUsername: "donna",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "donna" })).toBe("/help@otherbot");
  });
