...
function resolveAcpStreamCoalesceIdleMs(cfg: DonnaConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: DonnaConfig): number {
...
export function resolveAcpProjectionSettings(cfg: DonnaConfig): AcpProjectionSettings {
