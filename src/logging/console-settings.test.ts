...
let originalDonnaTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalDonnaTestConsole = process.env.DONNA_TEST_CONSOLE;
  process.env.DONNA_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalDonnaTestConsole === undefined) {
    delete process.env.DONNA_TEST_CONSOLE;
  } else {
    process.env.DONNA_TEST_CONSOLE = originalDonnaTestConsole;
  }
