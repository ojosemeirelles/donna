 ...
 * - AC2: Generates `.aiox/gotchas.md` consolidated
...
`;
    ...
    for (const category of Object.values(Category)) {
      ...
      const sorted = [...gotchasList].toSorted((a, b) => {
...
*Generated by AIOX Gotchas Documenter v${CONFIG.version}*
`;
        ...
        case "list": {
          ...
          if (format === "json") {
            ...
            for (const gotcha of gotchas) {
              ...
              if (gotcha.storyId) {
                console.log(`  Story: ${gotcha.storyId}`);
              }
              console.log("");
            }
          }
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - AIOX Memory Layer (Story 7.4)
