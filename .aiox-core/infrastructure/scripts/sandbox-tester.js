...
class SandboxTester {
  ...
  async createSandbox() {
    try {
      ...
      throw new Error(`Failed to create sandbox: ${error.message}`, { cause: error });
    }
  }
  ...
  async copyProject(sourcePath, options = {}) {
    ...
    try {
      ...
      throw new Error(`Failed to copy project: ${error.message}`, { cause: error });
    }
  }
  ...
  async applyImprovement(improvement) {
    try {
      ...
      throw new Error(`Failed to apply improvement: ${error.message}`, { cause: error });
    }
  }
  ...
  async compareResults(originalPath) {
    try {
      ...
      throw new Error(`Failed to compare results: ${error.message}`, { cause: error });
    }
  }
  ...
  async runCommand(cwd, command, options = {}) {
    ...
    try {
      ...
      // Handle timeout
      if (error.timedOut) {
        throw new Error(`Command timed out after ${timeout}ms`, { cause: error });
      }
  ...
  async getStats() {
    try {
      ...
      throw new Error(`Failed to get stats: ${error.message}`, { cause: error });
    }
  }
  ...
  async snapshot() {
    try {
      ...
      throw new Error(`Failed to create snapshot: ${error.message}`, { cause: error });
    }
  }
  ...
  async restore(snapshot) {
    try {
      ...
      throw new Error(`Failed to restore snapshot: ${error.message}`, { cause: error });
    }
  }
}
