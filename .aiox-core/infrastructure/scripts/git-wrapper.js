...
class GitWrapper {
  ...
  async initializeRepository() {
    try {
      ...
      throw new Error(`Failed to initialize git repository: ${error.message}`, { cause: error });
    }
  }
  ...
  async getCurrentBranch() {
    try {
      ...
      throw new Error(`Failed to get current branch: ${error.message}`, { cause: error });
    }
  }
  ...
  async createBranch(branchName, baseBranch = null) {
    try {
      ...
      throw new Error(`Failed to create branch ${branchName}: ${error.message}`, { cause: error });
    }
  }
  ...
  async stageFiles(files) {
    try {
      ...
      throw new Error(`Failed to stage files: ${error.message}`, { cause: error });
    }
  }
  ...
  async commit(message, options = {}) {
    try {
      ...
      throw new Error(`Failed to create commit: ${error.message}`, { cause: error });
    }
  }
...
${JSON.stringify(metadata, null, 2)}`;
  ...
  async getHistory(limit = 10) {
    try {
      ...
      throw new Error(`Failed to get history: ${error.message}`, { cause: error });
    }
  }
  ...
  async push(remote = "origin", branch = null, options = {}) {
    try {
      ...
      throw new Error(`Failed to push: ${error.message}`, { cause: error });
    }
  }
