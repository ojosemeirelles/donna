  ...
  if (type === "agent") {
    ...
    if (!parsed.agent) {
      ...
      if (!parsed.agent.icon) {
        errors.push("Missing agent.icon");
      }
    }
...
function getV2V3Diff(parsed, type) {
  ...
  if (type === "agent") {
    ...
    if (parsed.persona || parsed.persona_profile) {
      v2Fields.push("persona/persona_profile");
    }
    if (parsed.commands) {
      v2Fields.push("commands");
    }
    if (parsed.dependencies) {
      v2Fields.push("dependencies");
    }
    if (parsed["activation-instructions"]) {
      v2Fields.push("activation-instructions");
    }
    if (parsed["develop-story"]) {
      v2Fields.push("develop-story");
    }

    // V3 fields (new)
    if (parsed.autoClaude) {
      v3Fields.push("autoClaude.version");
      if (parsed.autoClaude.specPipeline) {
        v3Fields.push("autoClaude.specPipeline");
      }
      if (parsed.autoClaude.execution) {
        v3Fields.push("autoClaude.execution");
      }
      if (parsed.autoClaude.recovery) {
        v3Fields.push("autoClaude.recovery");
      }
      if (parsed.autoClaude.qa) {
        v3Fields.push("autoClaude.qa");
      }
      if (parsed.autoClaude.memory) {
        v3Fields.push("autoClaude.memory");
      }
      if (parsed.autoClaude.worktree) {
        v3Fields.push("autoClaude.worktree");
      }
    }
  }
  ...
  if (type === "task") {
    ...
    if (parsed.frontmatter) {
      v2Fields.push("frontmatter");
    }
    if (parsed.task) {
      v2Fields.push("task");
    }
    if (parsed.inputs) {
      v2Fields.push("inputs");
    }
    if (parsed.outputs) {
      v2Fields.push("outputs");
    }
    if (parsed.steps) {
      v2Fields.push("steps");
    }
    if (parsed.executionModes) {
      v2Fields.push("executionModes");
    }

    // V3 fields
    if (parsed.autoClaude) {
      v3Fields.push("autoClaude.version");
      if (parsed.autoClaude.deterministic !== undefined) {
        v3Fields.push("autoClaude.deterministic");
      }
      if (parsed.autoClaude.elicit !== undefined) {
        v3Fields.push("autoClaude.elicit");
      }
      if (parsed.autoClaude.pipelinePhase) {
        v3Fields.push("autoClaude.pipelinePhase");
      }
      if (parsed.autoClaude.verification) {
        v3Fields.push("autoClaude.verification");
      }
      if (parsed.autoClaude.selfCritique) {
        v3Fields.push("autoClaude.selfCritique");
      }
      if (parsed.autoClaude.recovery) {
        v3Fields.push("autoClaude.recovery");
      }
