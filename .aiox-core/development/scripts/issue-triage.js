...
function generateReport() {
  ...
  console.log(`\nBy Type:`);
  for (const [k, v] of Object.entries(stats.byType).toSorted((a, b) => b[1] - a[1])) {
    console.log(`  ${k}: ${v}`);
  }
  console.log(`\nBy Priority:`);
  for (const [k, v] of Object.entries(stats.byPriority).toSorted()) {
    console.log(`  ${k}: ${v}`);
  }
  console.log(`\nBy Area:`);
  for (const [k, v] of Object.entries(stats.byArea).toSorted((a, b) => b[1] - a[1])) {
    console.log(`  ${k}: ${v}`);
  }
  console.log(`\nBy Status:`);
  for (const [k, v] of Object.entries(stats.byStatus).toSorted((a, b) => b[1] - a[1])) {
    console.log(`  ${k}: ${v}`);
  }
}
