...
show_usage() {
    cat << EOF
clawlog - Donna Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Donna logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Donna logs flow through the macOS unified log (subsystem: ai.donna).
