...
export DISPLAY=:1
export HOME=/tmp/donna-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${DONNA_BROWSER_CDP_PORT:-${DONNA_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${DONNA_BROWSER_CDP_SOURCE_RANGE:-${DONNA_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${DONNA_BROWSER_VNC_PORT:-${DONNA_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${DONNA_BROWSER_NOVNC_PORT:-${DONNA_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${DONNA_BROWSER_ENABLE_NOVNC:-${DONNA_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${DONNA_BROWSER_HEADLESS:-${DONNA_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${DONNA_BROWSER_NO_SANDBOX:-${DONNA_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${DONNA_BROWSER_NOVNC_PASSWORD:-${DONNA_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${DONNA_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${DONNA_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${DONNA_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
