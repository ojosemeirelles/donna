...
# Output:
# - dist/Donna.app
# - dist/Donna-<version>.zip
# - dist/Donna-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.donna.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Donna.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Donna-$VERSION.zip"
DMG="$ROOT_DIR/dist/Donna-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Donna-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Donna-$VERSION.dSYM.zip"
