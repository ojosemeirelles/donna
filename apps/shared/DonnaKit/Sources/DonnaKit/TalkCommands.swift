...
public enum DonnaTalkCommand: String, Codable, Sendable {
...
public struct DonnaTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct DonnaTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
