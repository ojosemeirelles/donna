...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: DonnaProtocol.AnyCodable]?
    {
        ...
        return [
            "id": DonnaProtocol.AnyCodable(identity.deviceId),
            "publicKey": DonnaProtocol.AnyCodable(publicKey),
            "signature": DonnaProtocol.AnyCodable(signature),
            "signedAt": DonnaProtocol.AnyCodable(signedAtMs),
            "nonce": DonnaProtocol.AnyCodable(nonce),
        ]
    }
}
