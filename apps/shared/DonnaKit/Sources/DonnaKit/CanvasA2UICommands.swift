...
public enum DonnaCanvasA2UICommand: String, Codable, Sendable {
...
public struct DonnaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct DonnaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
