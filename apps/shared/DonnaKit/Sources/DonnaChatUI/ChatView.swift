...
@MainActor
public struct DonnaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: DonnaChatViewModel
    ...
    private var visibleMessages: [DonnaChatMessage] {
        let base: [DonnaChatMessage]
    ...
    private func mergeToolResults(in messages: [DonnaChatMessage]) -> [DonnaChatMessage] {
    ...
    private func isToolResultMessage(_ message: DonnaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: DonnaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: DonnaChatMessage) -> String {
