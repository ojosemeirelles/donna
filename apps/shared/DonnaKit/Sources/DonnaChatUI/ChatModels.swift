...
public typealias DonnaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias DonnaPlatformImage = UIImage
#endif

public struct DonnaChatUsageCost: Codable, Hashable, Sendable {
...
public struct DonnaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: DonnaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(DonnaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct DonnaChatMessageContent: Codable, Hashable, Sendable {
...
public struct DonnaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [DonnaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: DonnaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [DonnaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: DonnaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(DonnaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([DonnaChatMessageContent].self, forKey: .content) {
...
public struct DonnaChatHistoryPayload: Codable, Sendable {
...
public struct DonnaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct DonnaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [DonnaSessionPreviewItem]
}

public struct DonnaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [DonnaSessionPreviewEntry]

    public init(ts: Int, previews: [DonnaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct DonnaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct DonnaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct DonnaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct DonnaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct DonnaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct DonnaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: DonnaPlatformImage?
...
public struct DonnaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
