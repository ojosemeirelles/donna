...
android {
    namespace = "ai.donna.android"
    compileSdk = 36

    sourceSets {
        getByName("main") {
            assets.directories.add("../../shared/DonnaKit/Sources/DonnaKit/Resources")
        }
    }

    defaultConfig {
        applicationId = "ai.donna.android"
        minSdk = 31
        targetSdk = 36
    ...
    onVariants { variant ->
        variant.outputs
            ...
            .forEach { output ->
                ...
                val outputFileName = "donna-$versionName-$buildType.apk"
