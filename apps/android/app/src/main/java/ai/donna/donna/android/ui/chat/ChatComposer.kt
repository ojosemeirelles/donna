...
import ai.donna.android.ui.mobileSurface
import ai.donna.android.ui.mobileText
import ai.donna.android.ui.mobileTextSecondary
import ai.donna.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.donna.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.donna.android.ui.mobileFontFamily,
