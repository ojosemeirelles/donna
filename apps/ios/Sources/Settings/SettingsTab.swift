...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = DonnaLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = DonnaLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.donna.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Donna agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Donna. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(DonnaLocationMode.off.rawValue)
                            Text("While Using").tag(DonnaLocationMode.whileUsing.rawValue)
                            Text("Always").tag(DonnaLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Donna is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Donna", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = DonnaLocationMode(rawValue: newValue) else { return }
                Task {
