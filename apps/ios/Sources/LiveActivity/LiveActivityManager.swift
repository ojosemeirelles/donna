...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.donna.ios", category: "LiveActivity")
    private var currentActivity: Activity<DonnaActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = DonnaActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<DonnaActivityAttributes>.activities
    ...
    private func updateCurrent(state: DonnaActivityAttributes.ContentState) {
    ...
    private func connectingState() -> DonnaActivityAttributes.ContentState {
        DonnaActivityAttributes.ContentState(
    ...
    private func idleState() -> DonnaActivityAttributes.ContentState {
        DonnaActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> DonnaActivityAttributes.ContentState {
        DonnaActivityAttributes.ContentState(
