...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.donna.gateway"
    private static let nodeService = "ai.donna.node"
    private static let talkService = "ai.donna.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.donna.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.donna.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("donna-gateway.log")
    }
