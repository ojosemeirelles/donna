# Donna iOS (Super Alpha)

NO TEST FLIGHT AVAILABLE AT THIS POINT

This iPhone app is super-alpha and internal-use only. It connects to an Donna Gateway as a `role: node`.
...
- `apps/ios/Sources/Donna.entitlements` sets `aps-environment` to `development`.
