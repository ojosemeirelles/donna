...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.donna", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.donna", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [DonnaChatMessage] = messages.compactMap { item in
