...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .donnaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? DonnaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? DonnaPaths.stateDirURL.path
...
extension Notification.Name {
    static let donnaSelectSettingsTab = Notification.Name("donnaSelectSettingsTab")
}
