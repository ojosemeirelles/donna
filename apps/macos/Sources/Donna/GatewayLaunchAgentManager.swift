...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.donna", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".donna/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.donnaCommand(
            subcommand: "gateway",
