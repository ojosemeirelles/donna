...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.donna", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Donna windows, but below the system’s pop-up menus.
