...
enum DonnaConfigFile {
    private static let logger = Logger(subsystem: "ai.donna", category: "config")
    ...
    static func stateDirURL() -> URL {
        DonnaPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        DonnaPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-donna-config-file",
            "event": "config.write",
