...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/donna/donna") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/donna/donna")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://donna.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "DonnaBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DonnaBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "DonnaGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "DonnaGitCommit") as? String) ??
            "unknown"
    }
