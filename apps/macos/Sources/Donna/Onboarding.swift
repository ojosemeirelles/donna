...
enum UIStrings {
    static let welcomeTitle = "Welcome to Donna"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "donna.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: DonnaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g donna@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: DonnaChatViewModel(
