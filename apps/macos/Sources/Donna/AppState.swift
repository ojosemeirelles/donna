...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = DonnaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = DonnaConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = DonnaConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/donna"
        state.remoteCliPath = ""
        return state
    }
}
